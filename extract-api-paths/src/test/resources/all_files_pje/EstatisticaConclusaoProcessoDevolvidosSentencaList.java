...
@Name(EstatisticaConclusaoProcessoDevolvidosSentencaList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaConclusaoProcessoDevolvidosSentencaList extends
		AbstractEstatisticaConclusaoProcessoList<Map<String, Object>> {

	public static final String NAME = "estatisticaConclusaoProcessoDevolvidosSentencaList";
