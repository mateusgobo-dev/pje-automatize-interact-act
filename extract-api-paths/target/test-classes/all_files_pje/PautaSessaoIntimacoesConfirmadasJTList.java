...
@Name(PautaSessaoIntimacoesConfirmadasJTList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class PautaSessaoIntimacoesConfirmadasJTList extends AbstractPautaSessaoJTList<PautaSessao> {
	
	public static final String NAME = "pautaSessaoIntimacoesConfirmadasJTList";
	 ...
	 * é parte, mas também as tuplas nas quais ele é representante ou procurador de uma 
	 * parte.
	 */
	@Override
