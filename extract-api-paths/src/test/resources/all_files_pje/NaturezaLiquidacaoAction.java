...
@Name(NaturezaLiquidacaoAction.NAME)
@Scope(ScopeType.CONVERSATION)
@AutoCreate
public class NaturezaLiquidacaoAction extends GenericCrudAction<NaturezaClet> {
	...
	public static final String NAME = "naturezaLiquidacaoAction";
	...
	public void persist() {
		...
		getInstance().setTipoNatureza(TipoNaturezaCletEnum.L);
	...
	private boolean validaNomeNaturezaPersist(String nome){
		...
		sb.append("where o.tipoNatureza = 'L' ");
