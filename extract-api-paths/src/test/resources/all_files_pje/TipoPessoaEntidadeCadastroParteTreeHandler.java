...
@Name("tipoPessoaEntidadeCadastroParteTree")
@BypassInterceptors
public class TipoPessoaEntidadeCadastroParteTreeHandler extends AbstractTreeHandler<TipoPessoa> {
