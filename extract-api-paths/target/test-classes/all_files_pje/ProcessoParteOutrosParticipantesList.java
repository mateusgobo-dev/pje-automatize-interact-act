...
@Name(ProcessoParteOutrosParticipantesList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class ProcessoParteOutrosParticipantesList extends EntityList<ProcessoParte> {

	public static final String NAME = "processoParteOutrosParticipantesList";
	
	private static final long serialVersionUID = 1L;
	
	private static final String DEFAULT_EJBQL = "select ppa "+
												"from ProcessoParte ppa "+ 
												"where ppa.inParticipacao = 'T'  ";
