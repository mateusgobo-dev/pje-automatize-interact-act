...
@Entity
@Table(name = TopicoPreliminares.TABLE_NAME)
@PrimaryKeyJoinColumn(name = "id_topico")
public class TopicoPreliminares extends Topico {

	private static final long serialVersionUID = 1L;
	public static final String TABLE_NAME = "tb_topico_preliminares";

	public TopicoPreliminares() {
		setTipoTopico(TipoTopicoEnum.PRELIMINARES);
	}

	@Override
	@Transient
	public Topico getItemTopico() {
		Topico item = new TopicoItemPreliminares();
	...
	public Class<? extends Topico> getEntityClass() {
		return TopicoPreliminares.class;
	}
}
