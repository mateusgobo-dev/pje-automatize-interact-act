...
@Name(EstatisticaAudienciaProcessoSuspensosList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaAudienciaProcessoSuspensosList extends EntityList<Map<String, Object>> {

	public static final String NAME = "estatisticaAudienciaProcessoSuspensosList";
	...
	protected String getDefaultEjbql() {
		...
		if (ea.getDataInicioFormatada() != null && ea.getDataFimFormatada() != null) {
			...
			sb.append(" and o.statusAudiencia in ('N') ");
