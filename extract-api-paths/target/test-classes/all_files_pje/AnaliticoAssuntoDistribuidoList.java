...
@Name(AnaliticoAssuntoDistribuidoList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoDistribuidoList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoDistribuidoList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select new Map(o.processoTrf as distribuido) from EstatisticaProcessoJusticaFederal o ");
