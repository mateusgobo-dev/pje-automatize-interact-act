...
@Name(AnaliticoAssuntoReativadoList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoReativadoList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoReativado";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select new Map(o.processoTrf as reativado) from EstatisticaProcessoJusticaFederal o  ");
