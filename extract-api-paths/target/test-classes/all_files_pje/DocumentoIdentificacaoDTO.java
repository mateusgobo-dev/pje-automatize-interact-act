...
public class DocumentoIdentificacaoDTO implements Serializable{
	...
	public DocumentoIdentificacaoDTO() {
		super();
	}

	public DocumentoIdentificacaoDTO(String id, String dsDocumento, String nrDocumento, String nomePessoa, String[] filiacoes,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DocumentoIdentificacaoDTO other = (DocumentoIdentificacaoDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
