...
@Name(EstatisticaConclusaoProcessoConclusosSentencaList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaConclusaoProcessoConclusosSentencaList extends
		AbstractEstatisticaConclusaoProcessoList<Map<String, Object>> {

	public static final String NAME = "estatisticaConclusaoProcessoConclusosSentencaList";
