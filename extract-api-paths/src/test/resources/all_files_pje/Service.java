 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://www5.oab.org.br/cnaws/service.asmx?WSDL")
public class Service extends javax.xml.ws.Service {
	...
	static {
		...
		try {
			url = new URL("http://www5.oab.org.br/cnaws/service.asmx?WSDL");
