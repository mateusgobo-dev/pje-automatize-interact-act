...
@Name(TipoICRHome.NAME)
@BypassInterceptors
public class TipoICRHome extends AbstractTipoICRHome<TipoInformacaoCriminalRelevante> {

	public static final String NAME = "tipoICRHome";
	private static final long serialVersionUID = 1L;

	public static TipoICRHome instance() {
		return ComponentUtil.getComponent("tipoICRHome");
	}
