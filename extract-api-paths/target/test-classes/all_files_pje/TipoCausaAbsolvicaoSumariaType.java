 ...
 * 
 */
public class TipoCausaAbsolvicaoSumariaType extends EnumType<TipoCausaAbsolvicaoSumariaEnum> {

	private static final long serialVersionUID = 1L;

	public TipoCausaAbsolvicaoSumariaType() {
		super(TipoCausaAbsolvicaoSumariaEnum.CEI);
	}
