...
public abstract class EntityList<E> extends EntityQuery<E> {
	...
	private boolean mostraConsultaSemFiltro = Boolean.TRUE;
	...
	public List<E> getResultList() {
		setRestrictions();
		if (mostraConsultaSemFiltro || verificarFiltroPreenchido()) {
	...
	/**
	 * Retorna o resultList sem inicialização, ou seja, sem que a inicialização da consulta
	 * seja executada.
	 * 
	 * @return Lista de entidades.
	 */
	@SuppressWarnings("unchecked")
	public List<E> getResultListOriginal() {
		return (List<E>) ReflectionsUtil.getValue(this, "resultList");
	}
	
	/**
	 * Consulta a lista de entidades e armazena o resultado no atributo resultList. 
	 * 
	 * @param maxResult
	 */
		...
		visitFields(new FieldCommand() {
			...
			public void execute(SearchField s, Object object) {
				...
				sb.append(Messages.instance().get(MessageFormat.format("{0}.{1}", entityName, s.getName())))
						.append(" ").append(s.getCriteria()).append(" '").append(EntityList.toString(object))
						.append("'\n");
			}
	...
	/**
	 * Adiciona restrictions do EntityQuery baseado na string com as expressões.
	 * 
	 * @param restriction
	...
	public void setMostraConsultaSemFiltro(boolean mostraConsultaSemFiltro) {
