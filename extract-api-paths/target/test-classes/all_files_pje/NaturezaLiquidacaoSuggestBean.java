...
@Name("naturezaLiquidacaoSuggest")
@BypassInterceptors
public class NaturezaLiquidacaoSuggestBean extends AbstractSuggestBean<NaturezaClet>{
	...
	public String getEjbql() {
		return "select o from NaturezaClet o where o.ativo = true and o.tipoNatureza = 'L' "
