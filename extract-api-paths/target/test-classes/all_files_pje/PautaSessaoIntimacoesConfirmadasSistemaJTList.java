...
@Name(PautaSessaoIntimacoesConfirmadasSistemaJTList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class PautaSessaoIntimacoesConfirmadasSistemaJTList extends AbstractPautaSessaoJTList<PautaSessao> {
	
	public static final String NAME = "pautaSessaoIntimacoesConfirmadasSistemaJTList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append(						"and ppe.cienciaSistema is 'N' ");
		sb.append(						"and ( ");
		...
		sb.append(						"and ppe.prazoLegal > 0 and ppe.dtCienciaParte is not null ");
		sb.append(						"and ppe.dtCienciaParte <= ppe.dtPrazoProcessual) ");
		return sb.toString();
	}
	/*
	 * PJE-JT: Fim.
