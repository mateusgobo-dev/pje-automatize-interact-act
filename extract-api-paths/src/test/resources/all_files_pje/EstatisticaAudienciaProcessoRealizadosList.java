...
@Name(EstatisticaAudienciaProcessoRealizadosList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaAudienciaProcessoRealizadosList extends EntityList<Map<String, Object>> {

	public static final String NAME = "estatisticaAudienciaProcessoRealizadosList";
	...
	protected String getDefaultEjbql() {
		...
		if (ea.getDataInicioFormatada() != null && ea.getDataFimFormatada() != null) {
			...
			sb.append(" and o.statusAudiencia in ('F') ");
