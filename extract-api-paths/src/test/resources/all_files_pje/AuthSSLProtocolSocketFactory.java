package br.jus.cnj.mandadoprisao.webservices.seguranca;

/*
 * $Header: /home/cvs/jakarta-commons/httpclient/src/contrib/org/apache/commons/httpclient/contrib/ssl/AuthSSLProtocolSocketFactory.java,v 1.2 2004/06/10 18:25:24 olegk Exp $
 * $Revision: 1.2 $
 * $Date: 2004/06/10 18:25:24 $
 *
 * ====================================================================
 *
 ...
 * new URL("file:my.keystore"), "mypassword", new URL("file:my.truststore"),
 * "mypassword"), 443);
 * 
 * HttpClient client = new HttpClient();
 * client.getHostConfiguration().setHost("localhost", 443, authhttps); // use
 * relative url only GetMethod httpget = new GetMethod("/");
 * client.executeMethod(httpget); </pre>
 * </p>
 * <p>
 ...
 *         may be inappropriate to be used without additional customization.
 *         </p>
 */
