...
@Name(AnaliticoAssuntoArquivadoSemBaixaList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoArquivadoSemBaixaList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoArquivadoSemBaixaList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select new Map(o.processoTrf as arquivadoSemBaixa) from EstatisticaProcessoJusticaFederal o ");
		...
		sb.append("                                 where ep2.caminhoCompleto like concat(#{parametroUtil.eventoArquivamentoProvisorio.caminhoCompleto}, '%') ");
		sb.append("                          ) ");
		return sb.toString();
	}
