...
import br.com.infox.cliente.home.PessoaPeritoHome;
import br.com.infox.component.suggest.AbstractSuggestBean;
import br.jus.pje.nucleo.entidades.Municipio;

@Name("pessoaPeritoMunicipioSuggest")
@Scope(ScopeType.CONVERSATION)
@BypassInterceptors
public class PessoaPeritoMunicipioSuggestBean extends AbstractSuggestBean<Municipio> {
	...
	protected PessoaPeritoHome getHome() {
		return (PessoaPeritoHome) Component.getInstance("pessoaPeritoHome");
	}
