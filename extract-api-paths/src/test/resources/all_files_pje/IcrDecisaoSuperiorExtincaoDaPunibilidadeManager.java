...
@Name("icrDEPManager")
public class IcrDecisaoSuperiorExtincaoDaPunibilidadeManager extends
IcrDecisaoSuperiorManager<IcrDecisaoSuperiorExtincaoDaPunibilidade> {
	@Override
	protected InformacaoCriminalRelevante getIcrAfetada(IcrDecisaoSuperiorExtincaoDaPunibilidade entity) {
		return entity.getIcrAfetada();
	}

	@Override
	protected TipoIcrEnum[] getTiposDeIcrAceitos() {
		return IcrDecisaoSuperiorExtincaoDaPunibilidade.getTiposDeIcrAceitos();
	}

	@Override
	public Date getDtPublicacao(IcrDecisaoSuperiorExtincaoDaPunibilidade entity) {
		return entity.getDataPublicacao();
	}
	
	@Override
	protected boolean exigeTipificacaoDelito(IcrDecisaoSuperiorExtincaoDaPunibilidade entity) {
	...
	@Override
	protected void ensureUniqueness(IcrDecisaoSuperiorExtincaoDaPunibilidade entity) throws IcrValidationException {
		StringBuilder sb = new StringBuilder();
		if (entity.getId() == null) { // PERSIST
			sb.append("SELECT o FROM IcrDecisaoSuperiorExtincaoDaPunibilidade o where o.ativo = true");
		} else if (entity.getId() != null) { // UPDATE
			sb.append("SELECT o FROM IcrDecisaoSuperiorExtincaoDaPunibilidade o where o.ativo = true and o.id <> "
					+ entity.getId());
		}
