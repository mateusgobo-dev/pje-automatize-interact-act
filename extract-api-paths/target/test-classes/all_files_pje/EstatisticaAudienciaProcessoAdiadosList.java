...
@Name(EstatisticaAudienciaProcessoAdiadosList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaAudienciaProcessoAdiadosList extends EntityList<Map<String, Object>> {

	public static final String NAME = "estatisticaAudienciaProcessoAdiadosList";
	...
	protected String getDefaultEjbql() {
		...
		if (ea.getDataInicioFormatada() != null && ea.getDataFimFormatada() != null) {
			sb.append(" and to_char(o.dtRemarcacao,'yyyy-MM-dd') between #{estatisticaAudienciaAction.dataInicioFormatada} ");
			sb.append(" and #{estatisticaAudienciaAction.dataFimFormatada} ");
			sb.append(" and o.statusAudiencia in ('R') ");
