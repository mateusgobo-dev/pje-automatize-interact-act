...
@Name(AnaliticoAssuntoRemetidoTrfList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoRemetidoTrfList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoRemetidoTrfList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select new Map(o.processoTrf as remetidoTrf) from EstatisticaProcessoJusticaFederal o  ");
