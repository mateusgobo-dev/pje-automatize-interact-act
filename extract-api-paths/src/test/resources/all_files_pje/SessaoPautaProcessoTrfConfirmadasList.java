...
@Name(SessaoPautaProcessoTrfConfirmadasList.NAME)
@BypassInterceptors
@Scope(ScopeType.CONVERSATION)
public class SessaoPautaProcessoTrfConfirmadasList extends EntityList<SessaoPautaProcessoTrf> {

	public static final String NAME = "sessaoPautaProcessoTrfConfirmadasList";
	...
	private static final String R1 = "proc.numeroSequencia = #{sessaoPautaProcessoTrfConfirmadasList.numeroProcesso.numeroSequencia}";
	private static final String R2 = "proc.numeroDigitoVerificador = #{sessaoPautaProcessoTrfConfirmadasList.numeroProcesso.numeroDigitoVerificador}";
	private static final String R3 = "proc.ano = #{sessaoPautaProcessoTrfConfirmadasList.numeroProcesso.ano}";
	private static final String R4 = "proc.numeroOrigem = #{sessaoPautaProcessoTrfConfirmadasList.numeroProcesso.numeroOrigem}";
	private static final String R5 = "proc.numeroOrgaoJustica = #{sessaoPautaProcessoTrfConfirmadasList.numeroProcesso.numeroOrgaoJustica}";
	private static final String R6 = "proc.orgaoJulgador = #{sessaoPautaProcessoTrfConfirmadasList.orgaoJulgador}";
	...
	private static final String R9 = "proc in (select pp.processoTrf from ProcessoParte pp where pp.processoTrf = proc and "
			+ "lower(to_ascii(pp.pessoa.nome)) like '%' || lower(to_ascii(#{sessaoPautaProcessoTrfConfirmadasList.nomeParte})) || '%')";
	...
	private static final String R12 = "proc.idProcessoTrf in (select c.processo.idProcesso from ProcessoDocumento c where c.processo.idProcesso = proc.idProcessoTrf and "
			+ "c.tipoProcessoDocumento.tipoProcessoDocumento like #{sessaoPautaProcessoTrfConfirmadasList.relatorio ? 'Relatório' : null})";
	private static final String R13 = "o.processoExpediente.sessao.tipoSessao =  #{sessaoPautaProcessoTrfConfirmadasList.tipoSessao}";
	private static final String R14 = "cast(proc.dataDistribuicao as date) >= #{sessaoPautaProcessoTrfConfirmadasList.dtDistribuicaoInicio}";
	private static final String R15 = "cast(proc.dataDistribuicao as date) <= #{sessaoPautaProcessoTrfConfirmadasList.dtDistribuicaoFim}";
	private static final String R16 = "proc.orgaoJulgadorColegiado = #{sessaoPautaProcessoTrfConfirmadasList.orgaoJulgadorColegiado}";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("and o.cienciaSistema = false ");
