...
@Entity
@Table(name = TopicoPrejudiciais.TABLE_NAME)
@PrimaryKeyJoinColumn(name = "id_topico")
public class TopicoPrejudiciais extends Topico {

	private static final long serialVersionUID = 1L;
	public static final String TABLE_NAME = "tb_topico_prejudiciais";

	public TopicoPrejudiciais() {
		setTipoTopico(TipoTopicoEnum.PREJUDICIAIS);
	}

	@Override
	@Transient
	public Topico getItemTopico() {
		Topico item = new TopicoItemPrejudiciais();
	...
	public Class<? extends Topico> getEntityClass() {
		return TopicoPrejudiciais.class;
	}
}
