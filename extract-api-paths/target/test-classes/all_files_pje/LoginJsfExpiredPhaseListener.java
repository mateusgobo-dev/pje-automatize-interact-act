...
public class LoginJsfExpiredPhaseListener implements PhaseListener {

    private static final String POST_METHOD = "POST";
	private static final String LOGIN_SEAM = "/login.seam";
	/**
	 * 
	 */
    ...
    public void beforePhase(PhaseEvent event) {
    	...
    	if (isLoginPageAndHttpPost()) {
    		...
    		UIViewRoot viewRoot = viewHandler.restoreView(fc, LOGIN_SEAM);

    		// Se estiver nula -> árvore JSF expirou
            if (viewRoot == null) {
            	// Criar a árvore JSF
                viewRoot = viewHandler.createView(fc, LOGIN_SEAM);
