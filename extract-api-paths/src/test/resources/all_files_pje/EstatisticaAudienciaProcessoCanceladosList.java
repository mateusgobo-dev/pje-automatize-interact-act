...
@Name(EstatisticaAudienciaProcessoCanceladosList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaAudienciaProcessoCanceladosList extends EntityList<Map<String, Object>> {

	public static final String NAME = "estatisticaAudienciaProcessoCanceladosList";
	...
	protected String getDefaultEjbql() {
		...
		if (ea.getDataInicioFormatada() != null && ea.getDataFimFormatada() != null) {
			sb.append(" and to_char(o.dtInicio,'yyyy-MM-dd') between #{estatisticaAudienciaAction.dataInicioFormatada} ");
			sb.append(" and #{estatisticaAudienciaAction.dataFimFormatada} ");
			sb.append(" and o.statusAudiencia in ('C','D') ");
