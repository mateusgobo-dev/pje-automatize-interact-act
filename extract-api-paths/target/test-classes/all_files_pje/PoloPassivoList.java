...
@Name(PoloPassivoList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class PoloPassivoList extends EntityList<ProcessoParte> {

	public static final String NAME = "poloPassivoList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select o from ProcessoParte o where o.inParticipacao = 'P' ");
