 ...
 * 
 */
@Name(EstatisticaTramitacaoStarterProcessor.NAME)
...
public class EstatisticaTramitacaoStarterProcessor {

	public static final String NAME = "estatisticaTramitacaoStarterProcessor";
	public static final String ID_ESTATISCA_TRAMITACAO_PARAMETER = "IdEstatiscaTramitacaoParameter";
	...
	public EstatisticaTramitacaoStarterProcessor() {
	}
	...
	public void init() throws SchedulerException {
		...
		try {
			idTratarEventoTimer = TimerUtil.getParametro(ID_ESTATISCA_TRAMITACAO_PARAMETER);
		...
		if (idTratarEventoTimer == null) {
			...
			p.setNomeVariavel(ID_ESTATISCA_TRAMITACAO_PARAMETER);
			p.setSistema(true);
			String cronExpression = quartzProperties.getProperty("org.quartz.cronExpression", DEFAULT_CRON_EXPRESSION);
			EstatisticaTramitacaoProcessor processor = EstatisticaTramitacaoProcessor.instance();
			QuartzTriggerHandle handle = processor.verificarProcessosTramitacao(cronExpression);
