	...
	private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
		...
		// Example: DkLE
			...
			try {
				...
				// LogUtil.log(""+source[srcOffset]+ ": " + ( DECODABET[ source[
				// srcOffset ] ] ) );
				// LogUtil.log(""+source[srcOffset+1]+ ": " + ( DECODABET[
				// source[ srcOffset + 1 ] ] ) );
				// LogUtil.log(""+source[srcOffset+2]+ ": " + ( DECODABET[
				// source[ srcOffset + 2 ] ] ) );
				// LogUtil.log(""+source[srcOffset+3]+ ": " + ( DECODABET[
				// source[ srcOffset + 3 ] ] ) );
				return -1;
			} // end catch
		}
