...
@Name(ProcessoPartePoloPassivoList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class ProcessoPartePoloPassivoList extends EntityList<ProcessoParte> {

	public static final String NAME = "processoPartePoloPassivoList";
	
	private static final long serialVersionUID = 1L;
	
	private static final String DEFAULT_EJBQL = "select ppa "+
												"from ProcessoParte ppa "+ 
												"where ppa.inParticipacao = 'P'  ";
