...
public class DecisionNode extends Node {
	...
	public void execute(ExecutionContext executionContext) {
		...
		currentThread.setContextClassLoader(JbpmConfiguration.getProcessClassLoader(executionContext
		...
		try {
			if (decisionDelegation != null) {
				...
				if (transition == null) {
					throw new JbpmException("decision '" + name + "' selected non existing transition '"
							+ transitionName + "'");
				}
