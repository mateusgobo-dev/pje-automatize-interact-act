...
@Name(AnaliticoAssuntoMudancaClasseReentrList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoMudancaClasseReentrList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoMudancaClasseReentrList";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("select new Map(o.processoTrf as mudancaClasseReentr) from EstatisticaProcessoJusticaFederal o  ");
