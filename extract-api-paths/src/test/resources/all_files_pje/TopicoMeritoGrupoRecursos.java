...
@Entity
@Table(name = TopicoMeritoGrupoRecursos.TABLE_NAME)
@PrimaryKeyJoinColumn(name = "id_topico")
public class TopicoMeritoGrupoRecursos extends Topico {

	private static final long serialVersionUID = 1L;
	public static final String TABLE_NAME = "tb_topico_merito_grupo_recurso";
	
	public TopicoMeritoGrupoRecursos() {
		setTipoTopico(TipoTopicoEnum.MERITO_GRUPO_REC);
	}
	
	@Override
	@Transient
	public Topico getItemTopico() {
		Topico item = new TopicoMeritoRecurso();
	...
	public Class<? extends Topico> getEntityClass() {
		return TopicoMeritoGrupoRecursos.class;
	}
}
