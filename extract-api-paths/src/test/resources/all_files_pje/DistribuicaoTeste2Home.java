...
@Name("distribuicaoTeste2Home")
@Deprecated
public class DistribuicaoTeste2Home implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3631150396526802944L;
	...
	public void distribuir() {
		if (varaCargos != null && varaCargos.size() > 0) {
			SorteioVaraCargo2 sorteioVaraCargo = new SorteioVaraCargo2();
			...
			totalVaraMap = SorteioVaraCargo2.getTotalVaraMap(varaCargos);
		}
	}
