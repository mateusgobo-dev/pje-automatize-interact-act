...
@Name(SessaoPautaProcessoVotoConcordaList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class SessaoPautaProcessoVotoConcordaList extends EntityList<SessaoPautaProcessoVoto> {

	public static final String NAME = "sessaoPautaProcessoVotoConcordaList";

	private static final long serialVersionUID = 1L;

	private static final String DEFAULT_EJBQL = "select o from SessaoPautaProcessoVoto o "
			+ "where (o.usuarioRelator != o.usuarioDesembargadorAcompanhado or o.usuarioRelator is null) and o.usuarioVogal != #{usuarioLogado}";
