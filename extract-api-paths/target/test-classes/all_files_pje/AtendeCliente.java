...
public interface AtendeCliente {
    ...
    @RequestWrapper(localName = "consultaCEP", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", className = "br.jus.cnj.pje.webservice.client.correios.ConsultaCEP")
    @ResponseWrapper(localName = "consultaCEPResponse", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", className = "br.jus.cnj.pje.webservice.client.correios.ConsultaCEPResponse")
