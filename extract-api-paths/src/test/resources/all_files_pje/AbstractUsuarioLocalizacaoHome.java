...
public abstract class AbstractUsuarioLocalizacaoHome<T> extends AbstractHome<UsuarioLocalizacao> {
	...
	protected UsuarioLocalizacao createInstance() {
		...
		if (localizacaoHome != null) {
			usuarioLocalizacao.setLocalizacaoFisica(localizacaoHome.getDefinedInstance());
		}
	...
	public String remove() {
		...
		if (localizacao != null) {
			localizacao.getInstance().getUsuarioLocalizacaoList().remove(instance);
		}
		return super.remove();
	}
