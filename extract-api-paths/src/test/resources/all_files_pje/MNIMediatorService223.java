...
import br.jus.cnj.intercomunicacao.v223.beans.RequisicaoConsultaProcesso;
import br.jus.cnj.intercomunicacao.v223.beans.RespostaConsultaProcesso;
import br.jus.cnj.intercomunicacao.v223.beans.RespostaManifestacaoProcessual;
import br.jus.cnj.intercomunicacao.v223.servico.Intercomunicacao;
import br.jus.cnj.intercomunicacao.v223.servico.IntercomunicacaoService;
...
import br.jus.cnj.pje.intercomunicacao.v223.converter.ConsultarProcessoRequisicaoDTOConverter;
import br.jus.cnj.pje.intercomunicacao.v223.converter.ManifestacaoProcessualRequisicaoDTOConverter;
import br.jus.cnj.pje.intercomunicacao.v223.converter.RespostaConsultaProcessoConverter;
import br.jus.cnj.pje.intercomunicacao.v223.converter.RespostaManifestacaoProcessualConverter;
import br.jus.cnj.pje.intercomunicacao.v223.servico.IntercomunicacaoSoapImpl;
import br.jus.pje.nucleo.entidades.EnderecoWsdl;

/**
 * Classe de serviço responsável pela comunicação entre sistemas via MNI versão 2.2.3.
 * 
 * @author Adriano Pamplona
 */
@Name(MNIMediatorService223.NAME)
public class MNIMediatorService223 extends MNIMediatorServiceAbstract {
	public static final String NAME = "mniMediatorService223";
