...
@Name(SessaoPautaProcessoTrfFimPrazoDezList.NAME)
@BypassInterceptors
@Scope(ScopeType.CONVERSATION)
public class SessaoPautaProcessoTrfFimPrazoDezList extends EntityList<SessaoPautaProcessoTrf> {

	public static final String NAME = "sessaoPautaProcessoTrfFimPrazoDezList";
	...
	private static final String R1 = "o.processoJudicial.numeroSequencia = #{sessaoPautaProcessoTrfFimPrazoDezList.numeroProcesso.numeroSequencia}";
	private static final String R2 = "o.processoJudicial.numeroDigitoVerificador = #{sessaoPautaProcessoTrfFimPrazoDezList.numeroProcesso.numeroDigitoVerificador}";
	private static final String R3 = "o.processoJudicial.ano = #{sessaoPautaProcessoTrfFimPrazoDezList.numeroProcesso.ano}";
	private static final String R4 = "o.processoJudicial.numeroOrigem = #{sessaoPautaProcessoTrfFimPrazoDezList.numeroProcesso.numeroOrigem}";
	private static final String R5 = "o.processoJudicial.numeroOrgaoJustica = #{sessaoPautaProcessoTrfFimPrazoDezList.numeroProcesso.numeroOrgaoJustica}";
	private static final String R6 = "o.processoJudicial.orgaoJulgador = #{sessaoPautaProcessoTrfFimPrazoDezList.orgaoJulgador}";
	...
	private static final String R9 = "o.processoJudicial in (select pp.processoTrf from ProcessoParte pp where pp.processoTrf = o.processoJudicial and "
			+ "lower(to_ascii(pp.pessoa.nome)) like '%' || lower(to_ascii(#{sessaoPautaProcessoTrfFimPrazoDezList.nomeParte})) || '%')";
	private static final String R10 = "o.processoJudicial in (select pp.processoTrf from ProcessoParte pp where pp.processoTrf = o.processoJudicial "
	...
	private static final String R11 = "o.processoJudicial in (select pp.processoTrf from ProcessoParte pp "
			+ "where pp.processoTrf = o.processoJudicial and pp.pessoa.idUsuario IN (select pdi.pessoa.idUsuario from PessoaDocumentoIdentificacao pdi "
			+ "where pdi.tipoDocumento.codTipo = 'CPJ' and pdi.numeroDocumento like concat('%', #{consultaProcessoHome.instance.numeroCNPJ} ,'%')))";
	private static final String R12 = "o.processoJudicial.idProcessoTrf in (select c.processo.idProcesso from ProcessoDocumento c where c.processo.idProcesso = o.processoJudicial.idProcessoTrf and "
			+ "c.tipoProcessoDocumento.tipoProcessoDocumento like #{sessaoPautaProcessoTrfFimPrazoDezList.relatorio ? 'Relatório' : null})";
	private static final String R13 = "o.processoExpediente.sessao.tipoSessao =  #{sessaoPautaProcessoTrfFimPrazoDezList.tipoSessao}";
	private static final String R14 = "cast(o.processoJudicial.dataDistribuicao as date) >= #{sessaoPautaProcessoTrfFimPrazoDezList.dtDistribuicaoInicio}";
	private static final String R15 = "cast(o.processoJudicial.dataDistribuicao as date) <= #{sessaoPautaProcessoTrfFimPrazoDezList.dtDistribuicaoFim}";
	private static final String R16 = "o.processoJudicial.orgaoJulgadorColegiado = #{sessaoPautaProcessoTrfFimPrazoDezList.orgaoJulgadorColegiado}";
	...
	protected String getDefaultEjbql() {
		...
		sb.append("where o.processoExpediente.meioExpedicaoExpediente = 'E' ");
		...
		sb.append("and cast(current_date as date) <= cast(o.dtPrazoLegal as date)+10  ");
	...
	public String getIdProcessoParteExpedienteUsuarioLogado(SessaoPautaProcessoTrf sessaoPautaProcessoTrf) {
		...
		String sql = "select o from ProcessoParteExpediente o "
				...
				+ "	   or o.pessoaParte in (select o.pessoaProcuradoriaEntidade.pessoa from PessoaProcuradorProcuradoria o "
				+ "							where o.pessoaProcurador = :pessoa ))";
