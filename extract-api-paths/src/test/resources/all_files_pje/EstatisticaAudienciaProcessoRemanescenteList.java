...
@Name(EstatisticaAudienciaProcessoRemanescenteList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class EstatisticaAudienciaProcessoRemanescenteList extends EntityList<Map<String, Object>> {

	public static final String NAME = "estatisticaAudienciaProcessoRemanescenteList";
	...
	protected String getDefaultEjbql() {
		...
		if (ea.getDataInicioFormatada() != null && ea.getDataFimFormatada() != null) {
			sb.append(" and to_char(o.dtMarcacao,'yyyy-MM-dd') < #{estatisticaAudienciaAction.dataInicioFormatada} ");
			...
			sb.append(" and o.statusAudiencia in ('M','R') ");
