...
@Name(SessaoProcessoVotosAlteradosList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class SessaoProcessoVotosAlteradosList extends EntityList<SessaoProcessoDocumentoVoto> {

	public static final String NAME = "sessaoProcessoVotosAlteradosList";
	...
	private static final String DEFAULT_EJBQL = "select spdv from SessaoProcessoDocumentoVoto spdv "
			...
			+ "and spdv.orgaoJulgador != #{authenticator.getOrgaoJulgadorAtual()}";
