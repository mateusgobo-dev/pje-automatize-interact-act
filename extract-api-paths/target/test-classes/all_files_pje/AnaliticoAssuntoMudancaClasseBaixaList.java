...
@Name(AnaliticoAssuntoMudancaClasseBaixaList.NAME)
@BypassInterceptors
@Scope(ScopeType.PAGE)
public class AnaliticoAssuntoMudancaClasseBaixaList extends AbstractProcessoDistribuidoAnaliticoAssunto {

	public static final String NAME = "analiticoAssuntoMudancaClasseBaixaList";
