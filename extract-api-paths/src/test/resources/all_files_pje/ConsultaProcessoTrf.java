...
@Entity
@Table(name = ConsultaProcessoTrf.TABLE_NAME)
@FilterDefs(value = {
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_LOCALIZACAO_SERVIDOR, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_IDS_LOCALIZACOES_FISICAS_FILHAS),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_ORGAO_JULGADOR_COLEGIADO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_BOOLEAN, name = ConsultaProcessoTrfFilter.FILTER_PARAM_SERVIDOR_EXCLUSIVO_COLEGIADO),
				}),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_ORGAO_JULGADOR_COLEGIADO, parameters = { 
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_ORGAO_JULGADOR_COLEGIADO) }),

		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_CARGO, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO_LOCALIZACAO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_DATE, name = ConsultaProcessoTrfFilter.FILTER_PARAM_DATA_ATUAL) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_ORGAO_JULGADOR_CARGO, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO_LOCALIZACAO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_DATE, name = ConsultaProcessoTrfFilter.FILTER_PARAM_DATA_ATUAL) }),
				
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_ADVOGADO, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_LOCALIZACAO_FISICA) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_JUS_POSTULANDI, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_LOCALIZACAO_FISICA) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_PERITO, parameters = { 
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_PROCURADOR, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_TIPO_PROCESSO_DOCUMENTO_EXPEDIENTE) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_ASSISTENTE_PROCURADORIA, parameters = {
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_LOCALIZACAO_FISICA),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_TIPO_PROCESSO_DOCUMENTO_EXPEDIENTE) }),
		
		@FilterDef(name = ConsultaProcessoTrfFilter.FILTER_SEGREDO_JUSTICA, 
			parameters = { 
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_USUARIO), 
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_BOOLEAN, name=ConsultaProcessoTrfFilter.FILTER_PARAM_VISUALIZA_SIGILOSO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_IDS_LOCALIZACOES_FISICAS_FILHAS),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_INT, name = ConsultaProcessoTrfFilter.FILTER_PARAM_ID_ORGAO_JULGADOR_COLEGIADO),
				@ParamDef(type = ConsultaProcessoTrfFilter.TYPE_BOOLEAN, name = ConsultaProcessoTrfFilter.FILTER_PARAM_SERVIDOR_EXCLUSIVO_COLEGIADO),
				}), })
...
@Filters(value = {
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_PROCURADOR, condition = ConsultaProcessoTrfFilter.CONDITION_PROCURADOR),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_ASSISTENTE_PROCURADORIA, condition = ConsultaProcessoTrfFilter.CONDITION_ASSISTENTE_PROCURADORIA),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_ADVOGADO, condition = ConsultaProcessoTrfFilter.CONDITION_ADVOGADO),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_JUS_POSTULANDI, condition = ConsultaProcessoTrfFilter.CONDITION_JUS_POSTULANDI),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_PERITO, condition = ConsultaProcessoTrfFilter.CONDITION_PERITO),

		@Filter(name = ConsultaProcessoTrfFilter.FILTER_LOCALIZACAO_SERVIDOR, condition = ConsultaProcessoTrfFilter.CONDITION_LOCALIZACOES_SERVIDOR),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_ORGAO_JULGADOR_COLEGIADO, condition = ConsultaProcessoTrfFilter.CONDITION_ORGAO_COLEGIADO),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_CARGO, condition = ConsultaProcessoTrfFilter.CONDITION_CARGO),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_ORGAO_JULGADOR_CARGO, condition = ConsultaProcessoTrfFilter.CONDITION_ORGAO_JULGADOR_CARGO),
		@Filter(name = ConsultaProcessoTrfFilter.FILTER_SEGREDO_JUSTICA, condition = ConsultaProcessoTrfFilter.CONDITION_SEGREDO_JUSTICA)
	})
public class ConsultaProcessoTrf implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ConsultaProcessoTrf)) {
			return false;
		}
		ConsultaProcessoTrf other = (ConsultaProcessoTrf) obj;
