...
public class DeclinioCompetenciaTest {

    @Test
    public void buildMensagemDTO() throws JsonProcessingException {
        MensagemDTO mensagemDTO = new MensagemDTO(//Alterar protocolo, url e callback para outros declinios
                "20253000000000021",
                "https://portal-interno-api-tribunais.stg.pdpj.jus.br/api/v1/peticoes/por-protocolo/20253000000000021",
                "https://portal-interno-api-tribunais.stg.pdpj.jus.br/api/v1/protocolos/20253000000000021/callback",
                0
        );
        ...
        WebhookWrapperMessage webhookWrapperMessage = WebhookWrapperMessage.builder()
                .objeto("declinio_competencia")
                .formato("RAW")
                .criadoEm(new Timestamp(System.currentTimeMillis()))
                .numeroUnicoProcesso("0804867-31.2025.8.19.0031")//Trocar nro. do processo
